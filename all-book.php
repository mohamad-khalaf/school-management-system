                        ...
                        <form class="mg-b-20">
                            <div class="row gutters-8">
                                ...
                                <div class="col-4-xxxl col-xl-4 col-lg-3 col-12 form-group">
                                    <input type="text" placeholder="<?php echo lang('SEARCH_BY_NAME'); ?>" class="form-control">
                                </div>
                                    ...
                                    <tr>
                                        <th> 
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label"> <?php echo lang('ALL_BOOK'); ?> ID</label>
                                            </div>
                                        </th>
                                        ...
                                        <th> <?php echo lang('CREATING_DATE'); ?> </th>
                                        <th></th>
                                    </tr>
                                </thead>
                                <tbody>
