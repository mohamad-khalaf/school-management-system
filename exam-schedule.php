                            ...
                            <div class="card-body">
                                <div class="heading-layout1">
                                    <div class="item-title">
                                        <h3><?php echo lang('ADD_NEW_EXAM');?> </h3>
                                    </div>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item" href="#"><i
                                                    class="fas fa-times text-orange-red"></i><?php echo lang('CLOSE');?></a>
                                            <a class="dropdown-item" href="#"><i
                                                    class="fas fa-cogs text-dark-pastel-green"></i><?php echo lang('EDIT');?></a>
                                            <a class="dropdown-item" href="#"><i
                                                    class="fas fa-redo-alt text-orange-peel"></i><?php echo lang('REFRESH');?></a>
                                        </div>
                                    </div>
                                </div>
                                <form class="new-added-form">
                                    <div class="row">
                                        ...
                                        <div class="col-12-xxxl col-lg-6 col-12 form-group">
                                            <label><?php echo lang('SELECT_SEASON');?></label>
                                            <select class="select2">
                                                <option value="1">1</option>
                                                <option value="2">2</option>
                                                <option value="3">3</option>
                                        ...
                                        <div class="col-12-xxxl col-lg-6 col-12 form-group">
                                            <label><?php echo lang('SELECT_DATE');?></label>
                                            <input type="text" placeholder="YYYY/MM/DD" class="form-control air-datepicker" data-date-format="yyyy-mm-dd">
                    ...
                    <div class="col-8-xxxl col-12">
                        <div class="card height-auto">
                            <div class="card-body">
                                <div class="heading-layout1">
                                    <div class="item-title">
                                        <h3><?php echo lang('ALL_EXAM_SCHEDULE');?></h3>
                                    </div>
                                    <div class="dropdown">
                                ...
                                <form class="mg-b-20">
                                    <div class="row gutters-8">
                                        ...
                                        <div class="col-lg-4 col-12 form-group">
                                            <input type="text" placeholder="<?php echo lang('SEARCH_BY_EXAM');?>" class="form-control">
                                        </div>

                                        <div class="col-lg-3 col-12 form-group">
                                            <input type="text" placeholder="<?php echo lang('SEARCH_BY_SUBJECT');?>" class="form-control">
                                        </div>
                                            ...
                                            <tr>
                                                <th>
                                                    <div class="form-check">
                                                        ...
                                                        <label class="form-check-label"><?php echo 'id'; ?></label>
                                                    </div>
                                                </th>
                                                <!-- 2 -->
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="form-check">
                                                        ...
                                                        <label class="form-check-label"><?php echo 34534;?></label>
                                                    </div>
                                                </td>
                                                <td>33</td>
                                                <td>Mathematics</td>
