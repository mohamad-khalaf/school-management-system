...
if (isset($_SESSION['user_username']) ) :
    if ($_SESSION['user_group_id'] == '1' || $_SESSION['user_group_id'] == '4' )  :

    include('config.php');
    include('lang.php');
    $home_page    = 'HOME'; 
    $current_page = 'EXAM_GRADES';
    $parent_page  = 'ALL_EXAM_RESULTS';
    $alter_massage = '';
                            ...
                            <div class="card-body">
                                <div class="heading-layout1">
                                    <div class="item-title">
                                        <h3> <?php echo lang('ADD_NEW_GRADE'); ?> </h3>
                                    </div>
                                    <div class="dropdown">
                                ...
                                <form class="new-added-form" action="<?php echo $_SERVER['PHP_SELF'];  ?>" method="POST" >
                                    <div class="row">
                                        <div class="col-12-xxxl col-lg-6 col-12 form-group">
                                            <label> <?php echo lang('GRADE_NAME'); ?> </label>
                                            <input type="text" placeholder="" class="form-control" name="grade_name">
                                        </div>
                                        <div class="col-12-xxxl col-lg-6 col-12 form-group">
                                            <label> <?php echo lang('GRADE_POINT'); ?> </label>
                                            <select class="select2" name="grade_point">
                                        ...
                                        <div class="col-12-xxxl col-lg-6 col-12 form-group">
                                            <label> <?php echo lang('PERCENTAGE_FROM'); ?> </label>
                                            <input type="text" placeholder="" class="form-control" name="percent_from">
                                        </div>
                                        <div class="col-12-xxxl col-lg-6 col-12 form-group">
                                            <label> <?php echo lang('PERCENTAGE_UPTO'); ?> </label>
                                            <input type="text" placeholder="" class="form-control" name="percent_to">
                                        </div>
                                        <div class="col-12 form-group">
                                            <label> <?php echo lang('COMMENTS'); ?> </label>
                                            <textarea class="textarea form-control"  id="form-message"
                                                cols="10" rows="4" name="comment"></textarea>
                                        </div>
                    ...
                    <div class="col-8-xxxl col-12">
                        <div class="card height-auto">
                            <div class="card-body">
                                <div class="heading-layout1">
                                    <div class="item-title">
                                        <h3> <?php echo lang('EXAM_GRADE_LISTS'); ?> </h3>
                                    </div>
                                    <div class="dropdown">
                                        <a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown"
                                            aria-expanded="false">...</a>
                                            ...
                                            <tr>
                                                <th>
                                                    <div class="form-check">
                                                        ...
                                                        <label class="form-check-label"> <?php echo lang('GRADE_NAME'); ?> </label>
                                                    </div>
                                                </th>
                                                <th>Grade Point</th>
                                                <th>Percent From</th>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="form-check">
                                                                ...
                                                                <label class="form-check-label"> <?php echo $row['grade_name'] ?> </label>
                                                            </div>
                                                        </td>
                                                        <td><?php echo $row['grade_point'] ?></td>
                                                        <td><?php echo $row['percent_from'] ?></td>
                                                        <td><?php echo $row['percent_to'] ?></td>
