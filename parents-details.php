                        ...
                        <div class="single-info-details">
                            ...
                            ?>
                                ...
                                <div class="header-inline item-header">
                                    <h3 class="text-dark-medium font-medium"> <?php echo $row['full_name']; ?> </h3>
                                    ...
                                    <table class="table text-nowrap">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="font-medium text-dark-medium"> <?php echo $row['full_name']; ?> </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="font-medium text-dark-medium"><?php echo $row['religon']; ?></td>
                                            </tr>
                                            <tr>
