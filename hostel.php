...
if (isset($_SESSION['user_username']) ):
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') :
        ...
        $cost_bed       = $_POST['cost_bed'];

        
        $sql = "SELECT `hostel_name` FROM `hostel` WHERE `hostel_name` = '$hostel_name'";
        $res = mysqli_query($connect, $sql);
        $count = mysqli_num_rows($res);
        if (! $count > 0) {
        
            $sql = "INSERT INTO `hostel` (`hostel_name`, `room_num`, `room_type`, `number_bed`, `cost_bed`)
                                VALUES  ('$hostel_name','$room_num','$room_type','$number_bed','$cost_bed');";
            ...
            $alter_massage =  "name of hostel is exist";
        }
                            ...
                            <div class="card-body">
                                <div class="heading-layout1">
                                    <div class="item-title">
                                        <h3> <?php echo lang('ADD_NEW_ROOM'); ?> </h3>
                                    </div>
                                    <div class="dropdown">
                                ...
                                <form class="new-added-form" action="<?php echo $_SERVER['PHP_SELF'];  ?>" method="POST" >
                                    <div class="row">
                                        ...
                                        <div class="col-12-xxxl col-lg-6 col-12 form-group">
                                            <label> <?php echo lang('NUMBER_OF_BED'); ?> </label>
                                            <select class="select2" name="number_bed" >
                                        ...
                                        <div class="col-12-xxxl col-lg-6 col-12 form-group">
                                            <label>  <?php echo lang('COST_PER_BED'); ?> </label>
                                            <input type="text" placeholder="$00.00" class="form-control" name="cost_bed" >
                                        </div>
                    ...
                    <div class="col-8-xxxl col-12">
                        <div class="card height-auto">
                            <div class="card-body">
                                <div class="heading-layout1">
                                    <div class="item-title">
                                        <h3>  <?php echo lang($current_page); ?> Hostel Room Lists</h3>
                                    </div>
                                    <div class="dropdown">
                                        <a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown"
                                            aria-expanded="false">...</a>
                                            ...
                                            <tr>
                                                <th>
                                                    <div class="form-check">
                                                        ...
                                                        <label class="form-check-label"> <?php echo lang('CLOSE'); ?> Hostel Name</label>
                                                    </div>
                                                </th>
                                                <th>Room No</th>
                                                <th>Room Type</th>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="form-check">
                                                        ...
                                                        <label class="form-check-label"><?php echo $row['hostel_name']; ?></label>
                                                    </div>
                                                </td>
                                                <td> <?php echo $row['room_num'];    ?> </td>
                                                <td> <?php echo $row['room_type'];   ?> </td>
                                                <td> <?php echo $row['number_bed'];  ?> </td>
