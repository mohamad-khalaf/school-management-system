...
if (isset($_SESSION['user_username']) ) :
    ...
    // students count
    // $sql = 'SELECT `ar_full_name` FROM `students`';
    // $res = mysqli_query($connect, $sql);
    // if (! $res) {
    //     echo "Connect failed: %s\n", mysqli_error($connect);
    //     exit();
    // }
    // $count_students = mysqli_num_rows($res);
    $count_students = 55;
    
    // teacher count
    // $sql = 'SELECT `ar_full_name` FROM `teachers`';
    // $res = mysqli_query($connect, $sql);
    // if (! $res) {
    //     echo "Connect failed: %s\n", mysqli_error($connect);
    //     exit();
    // }
    // $count_teachers = mysqli_num_rows($res);
    $count_teachers = 88;

    // patent count
    // $sql = 'SELECT `full_name_ar` FROM `parents`';
    // $res = mysqli_query($connect, $sql);
    // if (! $res) {
    //     echo "Connect failed: %s\n", mysqli_error($connect);
    //     exit();
    // }
    // $count_parents = mysqli_num_rows($res);
    $count_parents = 68;
...
<body>
    ...
    <main id="wrapper" class="wrapper bg-ash">
        ...
        <div class="dashboard-page-one">
            ...
            <div class="dashboard-content-one">
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-6">
                                    <div class="item-content">
                                        <div class="item-title"> <?php echo lang('STUDENTS') ?> </div>
                                        <div class="item-number">
                                            <span class="counter" data-num="<?php echo $count_students; ?> "><?php echo $count_students; ?></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-3 col-sm-6 col-12">
                        <div class="dashboard-summery-one mg-b-20">
                            <div class="row align-items-center">
                                ...
                                <div class="col-6">
                                    <div class="item-content">
                                        <div class="item-title"> <?php echo lang('TEACHERS') ?> </div>
                                        <div class="item-number">
                                            <span class="counter" data-num="<?php echo +$count_teachers; ?>"><?php echo +$count_teachers; ?></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-3 col-sm-6 col-12">
                        <div class="dashboard-summery-one mg-b-20">
                            <div class="row align-items-center">
                                ...
                                <div class="col-6">
                                    <div class="item-content">
                                        <div class="item-title"><?php echo lang('PARENTS') ?> </div>
                                        <div class="item-number">
                                            <span class="counter" data-num="<?php echo $count_parents; ?>"><?php echo $count_parents; ?></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-3 col-sm-6 col-12">
                        <div class="dashboard-summery-one mg-b-20">
                            <div class="row align-items-center">
                                ...
                                <div class="col-6">
                                    <div class="item-content">
                                        <div class="item-title"> <?php echo lang('EARINGS') ?>  </div>
                ...
                <section class="row gutters-20">
                    <article class="col-12 col-xl-8 col-6-xxxl">
                        <div class="card dashboard-card-one pd-b-20">
                            <div class="card-body">
                                <div class="heading-layout1">
                                    <div class="item-title">
                                        <h3> <?php echo lang('EARINGS') ?> </h3>
                                    </div>
                                    <div class="dropdown">
                                ...
                                <div class="earning-report">
                                    <div class="item-content">
                                        <div class="single-item pseudo-bg-blue">
                                            <h4> <?php echo lang('TOTAL_COLLECTIONS') ?>  </h4>
                                            <span>75,000</span>
                                        </div>
                                        <div class="single-item pseudo-bg-red">
                                            <h4> <?php echo lang('FEES_COLLECTION') ?>  </h4>
                                            <span>15,000</span>
                                        </div>
                                    </div>
                                    <div class="dropdown">
                    ...
                    <article class="col-12 col-xl-4 col-3-xxxl">
                        <div class="card dashboard-card-two pd-b-20">
                            <div class="card-body">
                                <div class="heading-layout1">
                                    <div class="item-title">
                                        <h3> <?php echo lang('EXPENSES') ?>  </h3>
                                    </div>
                                    <div class="dropdown">
                                        <a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown"
                                            aria-expanded="false">...</a>
                    ...
                    <article class="col-12 col-xl-6 col-3-xxxl">
                    ...
                    <article class="col-12 col-xl-6 col-4-xxxl">
                    ...
                    <article class="col-lg-6 col-xl-6 col-4-xxxl">
                ...
                <?php include('layout/follow-us.php'); ?>
